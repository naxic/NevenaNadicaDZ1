 ...
 * \param [out] outstream_rez The stream should be of size (param_N * 4) bytes.
 */
void PassThrough(
	int32_t param_N,
	const uint32_t *instream_x,
	uint32_t *outstream_rez);
...
typedef struct { 
	...
	uint32_t *outstream_rez; /**<  [out] The stream should be of size (param_N * 4) bytes. */
